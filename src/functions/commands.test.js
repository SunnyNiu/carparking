...
describe('ReportCommand', () => {
  ...
  it('REPORT command will return car location and its facing direction', () => {
    const expected = [{ x: 1, y: 1, facing: 'NORTH' }, '1,1,NORTH'];
...
describe('MoveCommand', () => {
  ...
  it('MOVE command will not execute when it was at 5,5,EAST', () => {
    const expected = [{ x: 5, y: 5, facing: 'EAST' }, null];
    const command = new MoveCommand();
  ...
  it('MOVE command will not execute when it was at 5,5,NORTH', () => {
    const expected = [{ x: 5, y: 5, facing: 'NORTH' }, null];
    const command = new MoveCommand();
...
describe('PlaceCommand', () => {
  ...
  it('PLACE command ', () => {
    const expected = [{ x: 1, y: 1, facing: 'WEST' }, null];
    const command = new PlaceCommand('PLACE 1,1,WEST');
